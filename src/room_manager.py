...
class Room:
    ...
    async def broadcast_message(self, message, ws=None):
        if ws:
        ...
        while True:
            ...
            if accept_string in message:
                ...
                manager.send_personal_message(
                    f"Owner Of The Room {room_id} Has Not Accepted Your Request.", user)
            else:
                await self.broadcast_message(message, self.room_owner_ws)
